...
// import 'package:deep/components/search_screen.dart';
...
//                           children: [
//                             ..._content(
//                                 model.currentTodo!, _todoList, snapshot.data!),
//                           ],
//                           header: Card(
...
//         .toList()
//         .map(
//           (index) => GridTiles(Key(_todoList[index].id!), _todoList[index],
//               _pretodo, index, _allTodos, 2),
//         )
